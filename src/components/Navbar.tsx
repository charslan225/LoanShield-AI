      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-1.5 rounded-lg border border-[#2A2A2A] hover:border-[#3A3A3A] bg-[#111111] text-[#E0E0E0] text-xs font-semibold"
                >
                  <div className="w-6 h-6 rounded-full bg-[#FF6321]/20 text-[#FF6321] border border-[#FF6321]/30 flex items-center justify-center font-bold text-xs">
                ...
                {userMenuOpen && (
                  <div 
                    className="absolute right-0 mt-2 w-48 bg-[#111111] rounded-xl shadow-2xl border border-[#222222] py-1.5 z-50"
              ...
              <button
                id="nav-login-btn"
                onClick={onOpenAuth}
                className="px-4 py-2 rounded-lg bg-[#FF6321] text-black hover:bg-[#ff7538] text-xs font-bold shadow-md shadow-[#FF6321]/15 transition-all flex items-center space-x-1.5"
              >
            ...
            <button
              onClick={() => setCurrentView('analyze')}
              className="md:hidden p-2 rounded-lg bg-[#FF6321] text-black hover:bg-[#ff7538]"
              title="Analyze Loan"
            >
